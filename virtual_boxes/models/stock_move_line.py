...
class StockMoveLine(models.Model):
    ...
    @api.depends('move_id.num_boxes', 'quantity', 'move_id.product_uom_qty')
    def _compute_num_boxes(self):
        for line in self:
            move = line.move_id
            if move.num_boxes and move.product_uom_qty:
    ...
    def _get_aggregated_product_quantities(self, **kwargs):
        """Añade num_boxes al diccionario agrupado para el albarán impreso."""
